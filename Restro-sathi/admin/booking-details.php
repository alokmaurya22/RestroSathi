...
$sql_query = "update tblbookings set adminremark='$oremark',boookingStatus='$estatus' where id='$bid'";	
//echo $sql_query;
...
<head>
  ...
  <title>Restro Sathi  | Booking Details</title>
...
<?php if($result['boookingStatus']!=''):?>
            <tr>
				  ...
				  <?php
				  if($result['boookingStatus']=="Accepted"){
					  $clr = "green";
				  }
				  else{
					  $clr = "red";
				  ...
				  ?>
                    <td style="color:<?php echo $clr ?>;font-weight:700;"><?php echo $result['boookingStatus']?></td>
                    <th>Updation Date</th>
