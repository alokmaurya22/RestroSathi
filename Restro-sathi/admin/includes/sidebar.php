    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="dashboard.php" class="brand-link">
            <img src="../images/restro-sathi.png" alt="Brand Logo" class="brand-image img-circle elevation-3"
                style="opacity: 1;">
            <span class="brand-text font-weight-semibold">Restro Sathi</span>
        </a>
        <div class=" sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block"><?php  echo $_SESSION['Aname']." (".$_SESSION['uname'].")";?></a>
                </div>
            </div>
